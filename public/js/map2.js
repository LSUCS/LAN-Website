...
$(document).ready(function() {
    ...
    //Seat hover
    $("#room-1 .occupied-seat, #room-1 .ingame-seat, #room-2 .occupied-seat, #room-2 .ingame-seat, #room-3 .occupied-seat, #room-3 .ingame-seat").live('mouseover', function() {
        $(this).find('.seat-hover').show();
    });
    $("#room-1 .occupied-seat, #room-1 .ingame-seat, #room-2 .occupied-seat, #room-2 .ingame-seat, #room-3 .occupied-seat, #room-3 .ingame-seat").live('mouseleave', function() {

<?php
    ...
    class LanWebsite_Settings {
        ...
        private $defaults = array(
            ...
            "member_ticket_free" => array("bool", false, SettingsGroup::Tickets),
            ...
            "visitor_ticket_exists" => array("bool", true, SettingsGroup::Tickets),
            "visitor_ticket_available" => array("bool", true, SettingsGroup::Tickets),
            "visitor_ticket_available_date" => array("date", "2012-10-17 00:00:00", SettingsGroup::Tickets),
            "visitor_ticket_sold_out" => array("bool", false, SettingsGroup::Tickets),
            "visitor_ticket_price" => array("int", 5, SettingsGroup::Tickets),
            ...
            "main_presentation_url" => array("url", "https://docs.google.com/presentation/embed?id=1xSQaCi9f6lRTms75rQqLbYCPX88z6JegMQkTBNYAths&start=true&loop=true&delayms=15000", SettingsGroup::Presentation),
            "tournament_presentation_url" => array("url", "https://docs.google.com/presentation/embed?id=1xSQaCi9f6lRTms75rQqLbYCPX88z6JegMQkTBNYAths&start=true&loop=true&delayms=15000", SettingsGroup::Presentation),
            "twitch_user" => array("text", "lsuvgs", SettingsGroup::Presentation),
            "twitch_client_id" => array("text", "iqw3upeia100wtjaq3f61sraxbu6lw", SettingsGroup::Presentation),
            "presentation_refresh_interval" => array("int", 60000, SettingsGroup::Presentation),
            "twitch_check_interval" => array("int", 60000, SettingsGroup::Presentation),

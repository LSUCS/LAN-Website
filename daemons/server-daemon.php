<?php
    ...
    class Main {
        ...
        function __construct() {
            ...
            //Sleep interval
            $sleep = $this->settings->getSetting("server_daemon_sleep_period");
            ...
            while (1) {
                ...
                //Process
                file_get_contents($this->settings->getSetting("server_update_url"));
                ...
                $this->settings->changeSetting("server_browser_update_interval", ceil($exectime + $sleep));

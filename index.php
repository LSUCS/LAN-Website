<?php
    ...
    LanWebsite_Main::route(array("api", "home", "tickets", "whatson", "tournaments", "info", "account", "profile", "gallery", "map", "contact", "servers", "orderfood", "presentation", "chat", "gamehub", "stats"), "home");
